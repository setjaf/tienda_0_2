        ...
        <div class="w-100">
            <div class="card">
                <div class="card-header d-flex justify-content-around">
                    <span class="h4">{{ __('Proveedores') }}</span>
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <div class="card-body">
                                                ...
                                                <a href="#" class="btn btn-link editarProveedor" data-toggle="modal" data-target="#proveedorModal"
                                                    data-nombre='{{$proveedor->nombre}}'
                                                    data-idproveedor='{{$proveedor->id}}'
                                                    data-saldo='{{$proveedor->saldo}}'
                                                    data-activo='{{$proveedor->activo?1:0}}'
                                                >Editar proveedor</a>

                                                <a href="#" class="btn btn-link asociarProveedor" data-toggle="modal" data-target="#asociarModal"
                                                    data-nombre='{{$proveedor->nombre}}'
                                                    data-idproveedor='{{$proveedor->id}}'
                                                    data-saldo='{{$proveedor->saldo}}'
                                                    data-activo='{{$proveedor->activo?1:0}}'
