...
Route::post('/tienda/stock', 'Tienda\StockController@showStockFetch')->name('stock.fetch');
Route::post('/tienda/stock/buscar', 'Tienda\StockController@showStockBuscar')->name('stock.buscar');
